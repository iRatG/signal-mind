...
KEYWORDS = {
    "военная": [
        ...
        "беспилотник", "БПЛА", "дрон", "РЭБ", "фронт",
        "контрнаступление", "эвакуация", "обстрел", "ракетный удар", "ПВО",
    ],
    "геополитика": [
        "санкции", "контрсанкции", "параллельный импорт", "импортозамещение",
        "НАТО", "G7", "G20", "ШОС", "БРИКС",
        "заморозка активов", "недружественные страны", "переговоры", "перемирие",
        "разворот на восток",
    ],
    "экономика": [
        ...
        "бюджет", "дефицит бюджета", "ФНБ",
        "нефтегазовые доходы", "экспорт", "импорт", "торговый баланс",
    ],
    "рынки": [
        "акции", "облигации", "дивиденды", "IPO",
        "MOEX", "Московская биржа", "индекс МосБиржи", "РТС",
        "нефть", "Brent", "Urals", "природный газ", "СПГ",
        "дисконт", "потолок цен", "эмбарго", "делистинг", "редомициляция",
    ],
    "компании": [
        ...
        "Аэрофлот", "РЖД", "Росатом", "Ростех",
    ],
    "политика": [
        "Путин", "Мишустин", "Набиуллина",
        "Правительство", "Госдума",
        "национализация", "приватизация", "госкорпорация",
        "льготная ипотека", "нацпроект", "федеральный бюджет",
    ],
    "социальная": [
        "безработица", "занятость", "дефицит кадров",
        "зарплата", "МРОТ", "эмиграция", "релокация",
        "демография", "рождаемость", "пенсионная реформа",
    ],
    "технологии": [
        "искусственный интеллект", "нейросеть",
        "импортозамещение ПО", "цифровой рубль", "CBDC", "криптовалюта",
        "кибератака", "утечка данных", "суверенный интернет",
        "маркетплейс", "Wildberries", "Ozon", "финтех", "СБП",
    ],
}
